package com.example.homerental.User.ui.home;
...
import com.example.homerental.Adapters.AdapterImageProduct;
import com.example.homerental.Models.Products;
import com.example.homerental.R;
import com.example.homerental.User.SearchProducts;
...
//                    book.setbId(ds.getKey());
                    //adding each object
                    if(products.getpType().equals("HOMES"))
                        productsList.add(products);
                    else if(products.getpType().equals("BUILDING"))
